...
void CSudoku::SetParameters() {
	m_DigitsFiles = new bool[m_Dim * m_Dim];
	m_DigitsColumnes = new bool[m_Dim * m_Dim];
	m_DigitsCuadrats = new bool[m_Dim * m_Dim];
	for (int n = 0; n < m_Dim * m_Dim; n++) {
		m_DigitsFiles[n] == false;
		m_DigitsColumnes[n] == false;
		m_DigitsCuadrats[n] == false;
	}
